...
In order to support loading of multiple wallets in eliqa-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is eliqa.cpp.
...
Changes to eliqa.cpp
----------------------
eliqa.cpp is the entry point into eliqa-qt, and as such, will require some minor modifications to provide hooks for
