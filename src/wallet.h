...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT5000IFMN = 3,
    ONLY_NONDENOMINATED_NOT5000IFMN = 4, // ONLY_NONDENOMINATED and not 5000 Eliqa at the same time
...
public:
    ...
    void SetNull()
    {
        ...
        // Stake Settings
        nHashDrift = 45;
        nStakeSplitThreshold = 70000; // superlog 2000
        nHashInterval = 22;
    ...
    bool IsMine(const string& eliqa_address); 
