...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Eliqa features */
        {"eliqa", "masternode", &masternode, true, true, false},
        {"eliqa", "listmasternodes", &listmasternodes, true, true, false},
        {"eliqa", "getmasternodecount", &getmasternodecount, true, true, false},
        {"eliqa", "masternodeconnect", &masternodeconnect, true, true, false},
        {"eliqa", "masternodecurrent", &masternodecurrent, true, true, false},
        {"eliqa", "masternodedebug", &masternodedebug, true, true, false},
        {"eliqa", "startmasternode", &startmasternode, true, true, false},
        {"eliqa", "createmasternodekey", &createmasternodekey, true, true, false},
        {"eliqa", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"eliqa", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"eliqa", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"eliqa", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"eliqa", "getmasternodescores", &getmasternodescores, true, true, false},
        {"eliqa", "mnbudget", &mnbudget, true, true, false},
        {"eliqa", "preparebudget", &preparebudget, true, true, false},
        {"eliqa", "submitbudget", &submitbudget, true, true, false},
        {"eliqa", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"eliqa", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"eliqa", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"eliqa", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"eliqa", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"eliqa", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"eliqa", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"eliqa", "checkbudgets", &checkbudgets, true, true, false},
        {"eliqa", "mnsync", &mnsync, true, true, false},
        {"eliqa", "spork", &spork, true, true, false},
        {"eliqa", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"eliqa", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use eliqad, or the -server option to eliqa-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> eliqa-cli " + methodname + " " + args + "\n";
}
