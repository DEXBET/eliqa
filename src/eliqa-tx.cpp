...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Eliqa eliqa-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  eliqa-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded eliqa transaction") + "\n" +
                               "  eliqa-tx [options] -create [commands]   " + _("Create hex-encoded eliqa transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded eliqa transaction
