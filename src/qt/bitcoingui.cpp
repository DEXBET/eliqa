...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ELIQA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and eliqa: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Eliqa"), this);
    aboutAction->setStatusTip(tr("Show information about Eliqa"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ELIQA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ELIQA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ELIQA addresses"));
    ...
    openAction->setStatusTip(tr("Open a ELIQA: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Eliqa help message to get a list with possible ELIQA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Eliqa client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ELIQA network", "", count));
}
...
{
    QString strTitle = tr("Eliqa"); // default title
