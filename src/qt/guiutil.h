...
/** Utility functions used by the ELIQA Qt UI.
 */
namespace GUIUtil
{
...
// Render ELIQA addresses in monospace font
...
// Parse "eliqa:" URI into recipient object, return true on successful parsing
