/* src/config/eliqa-config.h.  Generated from eliqa-config.h.in by configure.  */
/* src/config/eliqa-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Eliqa_CONFIG_H

#define Eliqa_CONFIG_H
...
#define PACKAGE_BUGREPORT "eliqa.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Eliqa Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Eliqa Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "eliqa"
