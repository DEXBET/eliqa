...
#if defined(NDEBUG)
#error "ELIQA cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        nSubsidy = 17500000;
    } else if (nHeight <= 15840 && nHeight > 0) { // 10 days
        nSubsidy = 10;
    } else if (nHeight <= 25920 && nHeight > 15840) { // 7 days
        nSubsidy = 1500;
    } else if (nHeight <= 46080 && nHeight > 25920) { // 14 days
        nSubsidy = 150;
    } else {
        nSubsidy = 30;
    }
