...
{
public:
    /// Is the inputs associated with this public key? (and there is 350000 Eliqa - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of eliqa.
