...
RESOURCES += src/qt/eliqa.qrc src/qt/eliqa_locale.qrc

TRANSLATIONS += src/qt/locale/eliqa_bg.ts \
                src/qt/locale/eliqa_de.ts \
                src/qt/locale/eliqa_en.ts \
                src/qt/locale/eliqa_es.ts \
                src/qt/locale/eliqa_fi.ts \
                src/qt/locale/eliqa_fr.ts \
                src/qt/locale/eliqa_it.ts \
                src/qt/locale/eliqa_ja.ts \
                src/qt/locale/eliqa_pl.ts \
                src/qt/locale/eliqa_pt.ts \
                src/qt/locale/eliqa_ru.ts \
                src/qt/locale/eliqa_sk.ts \
                src/qt/locale/eliqa_sv.ts \
                src/qt/locale/eliqa_vi.ts \
                src/qt/locale/eliqa_zh_CN.ts \
                src/qt/locale/eliqa_zh_TW.ts
