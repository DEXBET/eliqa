...
This means one can have an always-on eliqad instance running, and another local eliqad/eliqa-qt instance which connects to this node and receives blocks from it.
