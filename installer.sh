...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='eliqa.conf'
CONFIGFOLDER='/root/.eliqa'
COIN_DAEMON='eliqad'
COIN_CLI='eliqa-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/eliqacoin/eliqa.git'
COIN_TGZ='https://github.com/eliqacoin/eliqa/releases/download/v1.0.0.1/eliqa-1.0.0-x86_64-linux-binaries.tar.gz'
