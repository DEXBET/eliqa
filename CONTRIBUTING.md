Contributing to Eliqa
============================

The Eliqa project operates an open contributor model where anyone is
...
The following applies to code changes to the Eliqa project, and is not to be
confused with overall ELIQA Network Protocol consensus changes.

Whether a pull request is merged into Eliqa rests with the project merge
...
Patches that change ELIQA consensus rules are considerably more involved than
...
Where a patch set proposes to change the ELIQA consensus, it must have been
...
The project leader is the release manager for each Eliqa release.
